...
title: Uma breve introdução sobre Motores de Busca
date: 2026-03-08
tags:
  - motores-de-busca
  - indexacao
...
![Diagrama da arquitetura do motor de busca](/assets/img/posts/2026-03-07/arquitetura.webp)
...
Detalhando um pouco mais esta fase, imaginemos que precisamos consumir (ou indexar) um determinado site. Para tanto necessitaremos de um consumidor deste tipo de fonte. Chamamos este componente de Crawler ou WebCrawler que nada mais é que um robô que varre todo o site alvo, navegando por cada link encontrado, armazenando todo o conteúdo no índice.
...
Auxiliam no trabalho de conectar e consumir diversas fontes de dados, como varrer um site, fazer integrações com outros sistemas (API) e rastrear um sistema de arquivos. Sua responsabilidade portanto, é injetar dados no motor de busca.
...
![Exemplo Banco de Dados](/assets/img/posts/2026-03-07/exemplo_indice.webp)
...
Na estrutura de índice invertido, que é utilizado por um motor de busca, esse conceito é diferente:

Press enter or click to view image in full size

![Exemplo Banco de Dados](/assets/img/posts/2026-03-07/exemplo_indice2.webp)
